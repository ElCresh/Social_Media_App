...
<html>
    ...
    <body>
        <div class="container-fluid" style="background-image: linear-gradient(100deg, #9fb8ad 0%, #0062cc 50%, #2cb5e8 100%); border-style: solid; border-color: black; max-height: max-content">
            ...
            <img src="../content/social-image.ico" alt="Social" class="img-header rounded-left" style="height: 12.9vw; width: 12.6vw;">
        </div>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <p class="text-info" style="font-size: 2vw; text-align: center">The application allows you to get the time-line of social media posts to which you are subscribed.</p>
